...
def hf_login(token: str, hf_home: str = None):
    ...
    if stored_token is None:
        print("🔑 未检测到已保存的 HuggingFace Token，正在登录...")
        login(token)
    else:
        try:
            user_info = whoami()
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default='/mnt/data/sysu/Users/wangzh/ID-Relight/models/hub/models--black-forest-labs--FLUX.1-dev/snapshots/3de623fc3c33e44ffbe2bad470d0f45bccf2eb21',
        required=False,
